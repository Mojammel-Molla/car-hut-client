...
const HowWeWorks = () => {
  return (
    <div
      className="lg:h-[60vh] mt-10 py-5"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-4 md:grid-cols-2 gap-5">
        <div className="w-64 text-center mx-auto space-y-2">
          <h1 className="text-6xl font-bold ">
            0<span className="text-[#d01818] font-extrabold">.</span>1
          </h1>
        ...
        <div className="w-64 text-center mx-auto space-y-2">
          <h1 className="text-6xl font-bold ">
            0<span className="text-[#d01818] font-extrabold">.</span>2
          </h1>
        ...
        <div className="w-64 text-center mx-auto space-y-2">
          <h1 className="text-6xl font-bold ">
            0<span className="text-[#d01818] font-extrabold">.</span>3
          </h1>
        ...
        <div className="w-64 text-center mx-auto space-y-2">
          <h1 className="text-6xl font-bold ">
            0<span className="text-[#d01818] font-extrabold">.</span>4
          </h1>
